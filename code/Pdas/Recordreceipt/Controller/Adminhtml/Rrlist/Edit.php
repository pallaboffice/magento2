...
class Edit extends \Pdas\Recordreceipt\Controller\Adminhtml\Rrlist
{
    ...
    public function execute()
    {
        ...
        $this->_coreRegistry->register('pdas_recordreceipt_rrlist', $model);
        
        // 3. Build edit form
        /** @var \Magento\Backend\Model\View\Result\Page $resultPage */
        $resultPage = $this->resultPageFactory->create();
        $this->initPage($resultPage)->addBreadcrumb(
            $id ? __('Edit Rrlist') : __('New Rrlist'),
            $id ? __('Edit Rrlist') : __('New Rrlist')
        );
        $resultPage->getConfig()->getTitle()->prepend(__('Rrlists'));
        $resultPage->getConfig()->getTitle()->prepend($model->getId() ? $model->getTitle() : __('New Rrlist'));
        return $resultPage;
    }
}
